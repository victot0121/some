            ...
            <div>
                <div className="container flex items-center h-screen p-6 mx-auto mt-6 space-y-0 justify-evenly md:space-y-0">
                    <div className='flex flex-col px-2 py-6'>
                        <h1 className='p-4 mt-6 text-5xl font-semibold text-white '>Fraud and <span className='bg-clip-text text-transparent bg-gradient-to-r from-[#E975A8] to-[#726CF8]'>security</span> </h1>
